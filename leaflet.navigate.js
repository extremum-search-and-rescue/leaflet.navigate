L.Control.NavigateTo = L.Control.extend({
    options: {
        position: 'bottomcenter',
        destinationMarkerOptions: {
            className: 'leaflet-control-navigate-marker',
            color: '#fff',
            fillColor: 'red',
            fillOpacity: 1,
            weight: 3,
